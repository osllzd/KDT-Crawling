...
def make_wordcloud(title_list, stopwords, word_count):
    ...
    wordcloud = WordCloud(font_path="path", width=800, height=600, background_color='white',
...
if __name__=='__main__':
    keywordList = ['인공지능산업', 'AI산업']

    for n in keywordList:
        search_word = n
        title_list = []
        stopwords = [search_word, 'AI산업']
        get_titles(1,30, search_word, title_list)
